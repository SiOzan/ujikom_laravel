                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Membuat Kategori Pengaduan</h3>
                            </div>
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form form-horizontal"
                                                action="{{ route('admin.kategoriPengaduan.store') }}" method="POST">
                                                @csrf
                                                <div class="form-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="first-name-horizontal">Nama Kategori Pengaduan <span
                                                        ...
                                                        <div class="col-sm-12 d-flex justify-content-end">
                                                            ...
                                                            <button type="reset"
                                                                class="btn btn-light-secondary me-1 mb-1"><a
