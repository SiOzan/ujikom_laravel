                                            ...
                                            <li class="dropdown-item notification-item">
                                                <a class="d-flex align-items-center" href="#">
                                                    ...
                                                    <div class="notification-text ms-4">
                                                        <p class="notification-title font-bold">{{ $item->judul }}
                                                        </p>
                                                        <p class="notification-subtitle font-thin text-sm">{{ $item->deskripsi }}
                                                        </p>
                                                    </div>
                                                </a>
                                            </li>
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Kontak Saran</h3>
                                <p class="text-subtitle text-muted">Daftar saran dari Masyarakat.</p>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($saran as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('admin.saran.destroy', $item->id) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="Hapus"
                                                            class="btn icon btn-sm btn-outline-danger rounded-pill"
