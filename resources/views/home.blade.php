                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="form-group">
                                    <label for="nama" class="form-label fs-6 fw-semibold">Nama Lengkap <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                           name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama lengkap Anda"
                            ...
                            <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="form-group">
                                    <label for="telepon" class="form-label fs-6 fw-semibold">Nomor Telepon <span class="text-danger">*</span></label>
                                    <input type="tel" class="form-control @error('telepon') is-invalid @enderror"
                                           name="telepon" value="{{ old('telepon') }}" placeholder="Masukkan nomor telepon Anda">
                                    @error('telepon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.6s">
                                <div class="form-group">
                                    <label for="kategori_id" class="form-label fs-6 fw-semibold">Kategori Pengaduan <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.7s">
                                <div class="form-group">
                                    <label for="prioritas" class="form-label fs-6 fw-semibold">Prioritas Masalah <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12 wow fadeInUp" data-wow-delay="0.9s">
                                <label for="judul" class="form-label fs-6 fw-semibold">Judul Masalah <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul"
                                       value="{{ old('judul') }}" placeholder="Masukkan judul masalah">
                                @error('judul')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 wow fadeInUp" data-wow-delay="1s">
                                <label for="deskripsi" class="form-label fs-6 fw-semibold">Deskripsi Masalah <span class="text-danger">*</span></label>
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi"
                                          rows="5" placeholder="Jelaskan secara rinci masalah yang Anda alami">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 wow fadeInUp" data-wow-delay="1.1s">
                                <label for="lokasi" class="form-label fs-6 fw-semibold">Alamat Lokasi Masalah <span class="text-danger">*</span></label>
                                <textarea class="form-control @error('lokasi') is-invalid @enderror" name="lokasi"
                                          rows="3" placeholder="Masukkan alamat lokasi masalah">{{ old('lokasi') }}</textarea>
                                @error('lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 text-end wow fadeInUp" data-wow-delay="1.2s">
                                <button type="submit" class="btn btn-gradient-primary px-5 py-2 shadow-sm rounded-3">Kirim Pengaduan</button>
                            </div>
                        </div>
                    </form>
                </div>
