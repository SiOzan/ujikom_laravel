    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('admin.index') }}">LaporIn</a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item {{ request()->routeIs('admin.user.*') || request()->routeIs('admin.petugas.*') ? 'active' : '' }} has-sub">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-person-badge-fill"></i>
                        <span>Petugas</span>
                    </a>
                    <ul
                        class="submenu {{ request()->routeIs('admin.user.*') || request()->routeIs('admin.petugas.*') ? 'active submenu-open' : 'submenu-closed' }}">
